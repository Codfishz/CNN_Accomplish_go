...
// This script contains some rudimentary training functions for most layers in our CNN implementation
...
func Test(){
	...
	fmt.Println("ALL TESTING PROCESS ENDS HERE, ALREADY MANUALLY VERIFIED FOR CORRECTION")
}
